...
// import CardSetup from './AddRecipe';
...
//     axios
//       .post(ingredientsURL, { text, ingredient })
...
//     axios
//       .put(`${ingredientsURL}/${id}`, { text, ingredient })
//       .then((res) => {
//         setIngredients(
...
//     axios.delete(`${ingredientsURL}/${id}}`).then((res) => {
...
//             <button
//               data-cy={`editBtn${i}`}
//               onClick={() => editIngredient(q.id)}
//             >
//               Edit
//             </button>
//             <button
//               data-cy={`deleteBtn${i}`}
//               onClick={() => deleteIngredient(q.id)}
//             >
//               Delete
//             </button>
//           </li>
